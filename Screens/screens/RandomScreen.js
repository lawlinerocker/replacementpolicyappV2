...
export const RandomScreen = ({navigation,route}) => {
  const pic_header = { uri: "https://i.ibb.co/7JPHxpy/RANDOM.png" }
  const pic_access = { uri: "https://i.ibb.co/M5yPRvP/ACCESS.png" }
  const pic_hitmiss = { uri: "https://i.ibb.co/zJP0Kmk/HIT-MISS.png" }
  const pic_evict = { uri: "https://i.ibb.co/TbdfbzY/EVICT.png" }
  const pic_result = { uri: "https://i.ibb.co/nfcwMbZ/RESULT.png"}
  const pic_hit = { uri: "https://i.ibb.co/MPQCwqp/HIT.png" }
  const pic_miss = { uri:"https://i.ibb.co/jrk5CCS/MISS.png"  }
  const pic_0 = { uri : "https://i.ibb.co/VmNLw1j/image.png"}
  const pic_1 = { uri : "https://i.ibb.co/SJB8PJK/1.png" }
  const pic_2 = { uri :"https://i.ibb.co/6ZThT0c/2.png" }
  const pic_3 = { uri : "https://i.ibb.co/Vg5jS0c/3.png" }
  const pic_hyphen = { uri :"https://i.ibb.co/Kww43B8/image.png" }
  const pic_01 = { uri :  "https://i.ibb.co/JjYWnp1/0-1.png"}
  const pic_02 = { uri : "https://i.ibb.co/PtFvNPC/0-2.png" }
  const pic_03 = { uri : "https://i.ibb.co/ZBPMMnp/0-3.png" }
  const pic_10 = { uri : "https://i.ibb.co/7NdT95J/1-0.png" }
  const pic_12 = { uri :  "https://i.ibb.co/7RGmNvX/1-2.png"}
  const pic_13 = { uri : "https://i.ibb.co/Rhv4g3C/1-3.png" }
  const pic_20 = { uri : "https://i.ibb.co/F35V1D4/2-0.png" }
  const pic_21 = { uri :  "https://i.ibb.co/fpqncWB/2-1.png"}
  const pic_23 = { uri :  "https://i.ibb.co/YRsV9c3/2-3.png"}
  const pic_30 = { uri :  "https://i.ibb.co/KVv34Mx/3-0.png"}
  const pic_31 = { uri :  "https://i.ibb.co/dbS73PK/3-1.png"}
  const pic_32 = { uri : "https://i.ibb.co/Sx9nj01/3-2.png" }
  const pic_012 = { uri :"https://i.ibb.co/kMS088k/0-1-2.png" }
  const pic_013 = { uri : "https://i.ibb.co/jZFg1SZ/0-1-3.png" }
  const pic_021 = { uri : "https://i.ibb.co/8Nk9hyM/0-2-1.png" }
  const pic_023 = { uri :  "https://i.ibb.co/dQsY9S5/0-2-3.png"}
  const pic_031 = { uri : "https://i.ibb.co/MgYDv6x/0-3-1.png" }
  const pic_032 = { uri : "https://i.ibb.co/wKH4X5t/0-3-2.png" }
  const pic_102 = { uri :  "https://i.ibb.co/gD9sj38/1-0-2.png"}
  const pic_103 = { uri :  "https://i.ibb.co/GT7SK3H/1-0-3.png"}
  const pic_120 = { uri :"https://i.ibb.co/VDCnbjF/1-2-0.png"}
  const pic_123 = { uri :  "https://i.ibb.co/mTXnWnL/1-2-3.png"}
  const pic_130 = { uri :  "https://i.ibb.co/NTd1JN8/1-3-0.png"}
  const pic_132 = { uri : "https://i.ibb.co/whB3YYY/1-3-2.png" }
  const pic_201 = { uri : "https://i.ibb.co/2gW78Lv/2-0-1.png" }
  const pic_203 = { uri : "https://i.ibb.co/jkdCQGh/2-0-3.png"}
  const pic_210 = { uri :  "https://i.ibb.co/QMjJfWJ/2-1-0.png"}
  const pic_213 = { uri : "https://i.ibb.co/Wk5dV5P/2-1-3.png" }
  const pic_230 = { uri :  "https://i.ibb.co/s2Dym94/2-3-0.png"}
  const pic_231 = { uri : "https://i.ibb.co/cgCVf9s/2-3-1.png" }
  const pic_301 = { uri : "https://i.ibb.co/MhXWjNP/3-0-1.png" }
  const pic_302 = { uri : "https://i.ibb.co/m8Rm3Mg/3-0-2.png" }
  const pic_310 = { uri : "https://i.ibb.co/qN0Rt74/3-1-0.png" }
  const pic_312 = { uri : "https://i.ibb.co/bF4jYXs/3-1-2.png" }
  const pic_320 = { uri : "https://i.ibb.co/98NcDmN/3-2-0.png" }
  const pic_321 = { uri : "https://i.ibb.co/G5cPP3g/3-2-1.png"}
  const pic_back = { uri : "https://i.ibb.co/XLqVN5K/image.png" }
