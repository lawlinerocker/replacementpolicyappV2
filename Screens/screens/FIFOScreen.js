...
export const FIFOScreen = ({navigation,route}) => {
  const pic_header = { uri: "https://i.ibb.co/kXSPPFt/FIFO.png" }
  const pic_access = { uri: "https://i.ibb.co/JqBZ6HZ/ACCESS.png" }
  const pic_hitmiss = { uri: "https://i.ibb.co/Sx3DqgS/HIT-MISS.png"}
  const pic_evict = { uri: "https://i.ibb.co/xD4QHBZ/EVICT.png" }
  const pic_result = { uri: "https://i.ibb.co/9wp49zD/RESULT.png"}
  const pic_hit = { uri:  "https://i.ibb.co/QcnZgtk/HIT.png"}
  const pic_miss = { uri: "https://i.ibb.co/3yZrHnD/MISS.png"}
  const pic_0 = { uri : "https://i.ibb.co/dp4CD0N/image.png"}
  const pic_1 = { uri :  "https://i.ibb.co/KxGBqKH/1.png"}
  const pic_2 = { uri : "https://i.ibb.co/rtBsMJ6/2.png"}
  const pic_3 = { uri :  "https://i.ibb.co/VVstFRS/3.png"}
  const pic_hyphen = { uri : "https://i.ibb.co/nm44zLR/image.png" }
  const pic_01 = { uri : "https://i.ibb.co/dPmkXt1/0-1.png"}
  const pic_02 = { uri : "https://i.ibb.co/wy63rZZ/0-2.png" }
  const pic_03 = { uri :  "https://i.ibb.co/ZT7j5t6/0-3.png"}
  const pic_10 = { uri : "https://i.ibb.co/9sBjgbw/1-0.png"}
  const pic_12 = { uri :  "https://i.ibb.co/DLY61st/1-2.png"}
  const pic_13 = { uri :  "https://i.ibb.co/7QP8zx4/1-3.png"}
  const pic_20 = { uri : "https://i.ibb.co/FmHrBvf/2-0.png"}
  const pic_21 = { uri : "https://i.ibb.co/bNjMWpp/2-1.png"}
  const pic_23 = { uri : "https://i.ibb.co/Y7T5RsR/2-3.png"}
  const pic_30 = { uri : "https://i.ibb.co/X3gzsVy/3-0.png" }
  const pic_31 = { uri : "https://i.ibb.co/t4RTJdy/3-1.png"}
  const pic_32 = { uri : "https://i.ibb.co/Kwxzm1v/3-2.png" }
  const pic_012 = { uri :  "https://i.ibb.co/J2zQghS/0-1-2.png"}
  const pic_013 = { uri :  "https://i.ibb.co/tXt3BKh/0-1-3.png"}
  const pic_021 = { uri : "https://i.ibb.co/VD9DrYV/0-2-1.png"}
  const pic_023 = { uri : "https://i.ibb.co/HNWshDd/0-2-3.png" }
  const pic_031 = { uri :  "https://i.ibb.co/cxYRkdC/0-3-1.png"}
  const pic_032 = { uri : "https://i.ibb.co/X50PFd3/0-3-2.png"}
  const pic_102 = { uri : "https://i.ibb.co/m8yRP6Y/1-0-2.png"}
  const pic_103 = { uri : "https://i.ibb.co/g7bxHvV/1-0-3.png" }
  const pic_120 = { uri :  "https://i.ibb.co/nMHHVz3/1-2-0.png"}
  const pic_123 = { uri : "https://i.ibb.co/HhWsbPH/1-2-3.png" }
  const pic_130 = { uri :  "https://i.ibb.co/R3Lktsf/1-3-0.png" }
  const pic_132 = { uri :  "https://i.ibb.co/2ZNZRnD/1-3-2.png"}
  const pic_201 = { uri :  "https://i.ibb.co/Pw1Q6Y7/2-0-1.png"}
  const pic_203 = { uri : "https://i.ibb.co/pbvQq5d/2-0-3.png" }
  const pic_210 = { uri : "https://i.ibb.co/d0T0kym/2-1-0.png" }
  const pic_213 = { uri :  "https://i.ibb.co/Gt2PB5F/2-1-3.png"}
  const pic_230 = { uri : "https://i.ibb.co/JH5BYRP/2-3-0.png"}
  const pic_231 = { uri : "https://i.ibb.co/Nnk2vcq/2-3-1.png" }
  const pic_301 = { uri : "https://i.ibb.co/27ZPjSz/3-0-1.png" }
  const pic_302 = { uri : "https://i.ibb.co/MGKMBCY/3-0-2.png" }
  const pic_310 = { uri : "https://i.ibb.co/FhttkbC/3-1-0.png" }
  const pic_312 = { uri : "https://i.ibb.co/5BPMQ8Q/3-1-2.png" }
  const pic_320 = { uri : "https://i.ibb.co/YQqmMFG/3-2-0.png"}
  const pic_321 = { uri : "https://i.ibb.co/HVD4c6W/3-2-1.png" }
  const pic_back = { uri : "https://i.ibb.co/bsYkCSg/image.png" }
